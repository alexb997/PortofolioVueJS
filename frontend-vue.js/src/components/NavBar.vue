<template>
  <b-container class="sideBar">
    <b-container class=" buttons-zone">
      <b-row class="pt-5 pb-3"><a href="/">Home</a></b-row>
      <b-row class="pb-3"><a href="/projects">Projects</a></b-row>
      <b-row class="pb-3"><a href="/blog">Blog</a></b-row>
    </b-container>
